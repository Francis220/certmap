    ...
    <div className="max-w-3xl mx-auto px-6 py-10">
      ...
      <div className="space-y-0">
        {[
          ...
          },
          {
            ...
            a: "Open an issue on GitHub or email the maintainer. Data errors — wrong system attributed to a jurisdiction, stale cert status — are the most useful to report.",
          },
        ].map(({ q, a }) => (
      ...
      <div className="mt-10 pt-6 border-t border-line">
        <p className="font-mono text-xs text-mid">
          Data:{" "}
          <a href="https://www.eac.gov/voting-equipment/certified-voting-systems" target="_blank" rel="noopener noreferrer" className="hover:text-ink underline">
            EAC Certified Systems
          </a>
          {" · "}
          <a href="https://www.eac.gov/research-and-data/election-administration-voting-survey" target="_blank" rel="noopener noreferrer" className="hover:text-ink underline">
            EAVS 2024
          </a>
          {" · "}
          <Link href="/data" className="hover:text-ink underline">Download dataset</Link>
        </p>
      </div>
    </div>
  );
